...
## Prioritised Questions for the Applicant
...
| **Omit** | Sleeping arrangements, previous occupants | Risk of appearing vexatious |

---

## PART A: QUESTIONS (Priority Order)

### 1. Form E Clarifications

**1.1** At Question 1.8 of Form E you answered "No" to the question "Are you living with a new partner?" However, you have completed Section 4.6, which is headed: *"If you have subsequently married or formed a civil partnership (or intend to) or are living with another person (or intend to), give brief details..."*

Please clarify the apparent inconsistency between your answer at Question 1.8 and your completion of Section 4.6.

**1.2** Your income needs schedule at Section 3.1.1 totals £650 per month and includes mobile phone, holidays, petrol, and car insurance. It contains no provision for:
- Rent or mortgage
- Council tax
...
Please confirm:
(a) Your monthly expenditure on each of these items;
(b) If you do not pay for any of these items, who meets these costs on your behalf.

---

### 2. Current Living Arrangements & Housing Costs

**2.1** Please confirm:
(a) The monthly rent payable at 12A Newhaven Court;
(b) Your monthly contribution towards that rent;
(c) Whether any other person contributes to or pays that rent on your behalf.

**2.2** Please provide a copy of the tenancy agreement for 12A, including the names of all tenants and the commencement date.

**2.3** Your bank statements show no deposit, agency fee, or first month's rent payment in connection with your move to 12A on or around 13 November 2025. Please confirm:
(a) Who paid any deposit and/or first month's rent;
(b) The amount paid;
(c) Whether this sum is repayable by you.

**2.4** Please provide details of any financial arrangements between yourself and Mr Thorne, including any contributions he makes towards household expenses, rent, utilities, or other costs.
...
## Explanatory Notes (Not for Submission)

### New Questions Added Following Form E Review

| New Question | Basis | Why Material |
|--------------|-------|--------------|
...
|-------------------|---------------------|
| Sleeping arrangements at 12A | Intrusive; unlikely to be ordered; risks appearing vexatious |
...
1. **Lead with the Form E contradictions**: Questions 1.1 and 1.2 are now first because they arise directly from her own sworn disclosure. You're not making accusations - you're asking her to explain inconsistencies in her own document. This is hard to criticise.
...
### Summary of Key Points from Form E

| Item | Form E Discloses | Issue |
|------|------------------|-------|
